...
python3 -u "./shrimp_cfmU.py" \
    --label "05073086815f28c8c9167b69daab7f2b" \
    --epochs "200" \
    --batch-size "4" \
    --timesteps "250" \
    ...
    > ./job_logs/${PBS_JOBID}_05073086815f28c8c9167b69daab7f2b.log 2>&1 &
python3 -u "./shrimp_cfmU.py" \
    --label "3646c3eb3550f71c0a1e563964d0ce8e" \
    --epochs "200" \
    --batch-size "4" \
    --timesteps "500" \
    --sampling-timesteps "100" \
    ...
    --model-path "./h0-f0/models" \
    --results "./h0-f0/results" \
    > ./job_logs/${PBS_JOBID}_3646c3eb3550f71c0a1e563964d0ce8e.log 2>&1
wait
