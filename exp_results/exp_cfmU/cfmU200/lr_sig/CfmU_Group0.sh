...
python3 -u "./shrimp_cfmU.py" \
    --label "1d415baff80db77ec4986e4cabd0525f" \
    --epochs "200" \
    --batch-size "4" \
    --timesteps "1000" \
    ...
    > ./job_logs/${PBS_JOBID}_1d415baff80db77ec4986e4cabd0525f.log 2>&1 &
python3 -u "./shrimp_cfmU.py" \
    --label "270b2bd7be9284218502c53a267fd621" \
    --epochs "200" \
    --batch-size "4" \
    --timesteps "1000" \
    --sampling-timesteps "500" \
    ...
    --model-path "./h0-f0/models" \
    --results "./h0-f0/results" \
    > ./job_logs/${PBS_JOBID}_270b2bd7be9284218502c53a267fd621.log 2>&1
wait
