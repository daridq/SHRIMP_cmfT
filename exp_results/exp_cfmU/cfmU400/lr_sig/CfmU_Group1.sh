...
python3 -u "./shrimp_cfmU.py" \
    --label "511abe80957b414294fe5ee1f47c7af6" \
    --epochs "400" \
    --batch-size "8" \
    --timesteps "1000" \
    ...
    > ./job_logs/${PBS_JOBID}_511abe80957b414294fe5ee1f47c7af6.log 2>&1 &
python3 -u "./shrimp_cfmU.py" \
    --label "97941088a9c5dca305767eb377c440b4" \
    --epochs "400" \
    --batch-size "8" \
    --timesteps "1000" \
    --sampling-timesteps "500" \
    ...
    --model-path "./h0-f0/models" \
    --results "./h0-f0/results" \
    > ./job_logs/${PBS_JOBID}_97941088a9c5dca305767eb377c440b4.log 2>&1
wait
