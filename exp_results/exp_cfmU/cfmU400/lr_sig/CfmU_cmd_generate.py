...
base_params = {
    ...
    "epochs": [400],  # Reduced from 400 - CFM typically converges faster
    "batch_size": [8],  # CFM is more stable with larger batches
    
    # Flow Matching specific parameters
    "timesteps": [1000],  # Reduced from 1000 - CFM needs fewer timesteps
    "sampling_timesteps": [500],  # Much reduced from 500 - CFM sampling is more efficient
    "path_type": ["optimal_transport"],  # CFM specific path type
    "sigma_min": [0.005, 0.01],  # CFM specific minimum noise level
    ...
    "learning_rate": [0.0005, 0.001],  # CFM learning rate
