...
python3 -u "./shrimp_cfmU.py" \
    --label "1ea0f32bde635ef9db1095bbc751d7fa" \
    --epochs "400" \
    --batch-size "8" \
    --timesteps "1000" \
    ...
    > ./job_logs/${PBS_JOBID}_1ea0f32bde635ef9db1095bbc751d7fa.log 2>&1 &
python3 -u "./shrimp_cfmU.py" \
    --label "476b0687084ba133e027dc7f48df23b6" \
    --epochs "400" \
    --batch-size "8" \
    --timesteps "1000" \
    --sampling-timesteps "500" \
    ...
    --model-path "./h0-f0/models" \
    --results "./h0-f0/results" \
    > ./job_logs/${PBS_JOBID}_476b0687084ba133e027dc7f48df23b6.log 2>&1
wait
